...
def setup_admin(app, db):
    ...
    # Temporary: Use simple ModelView for MataKuliah
    simple_mk_view = ModelView(MataKuliah, db.session, name="Data Mata Kuliah", category="Manajemen")
    simple_mk_view.form_excluded_columns = ['records']
    admin.add_view(simple_mk_view)
